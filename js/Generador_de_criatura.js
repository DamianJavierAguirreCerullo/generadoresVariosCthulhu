...
var Grimorio_ambientales = ["Aliento de la muerte","Alteracion meteorologica","Arenas de la separacion","Crear niebla de R´lyeh","Desafiar la gravedad","Hambre de Kazan","Levantar niebla nocturna","Llamar al rayo","Maldición de Apofis","Mirada solar","Mitigar la luz","Ola del olvido","Traer el Haboob"]

var Gromorio_daño_nocombat = ["Abismo al infierno","Abrazo de Yog-Sothoth","Absorber la juventud","Absorber la vida","Activacion","Arbusto humano","Atar un alma","Bacanal","Barrera de dolor","Cimoticismo","Corrupcion de lo sagrado","Decadencia insidiosa","Descomposicion verde","Desgarrar velo","Despertar a la Gran Tortuga","Destierro por nombre","Detener corazón","Ensalmo de la sexta sathlatta","Enviar a los muertos","Enivar serpiente sagrada","Flautas de locura","Fundir carne","Iluminacion instantánea","Larvas","Llamar a la Negrura","Llamar al rayo","Mal de ojo","Maldición de Chaugnar Faugn","Maldición del pellejo pútrido","La maldición marchitante","Maleficio de las runas","Mirada envenenada","Necrosis","Ojo maldito","Pesadilla","Pesadillas","Petrificar","Provocar la enfermedad","Provocar/Curar la ceguera","Retirar velo","Signo amarillo","Sombra de Nyarlathotep","Traer la peste"]

var Grimorio_combate= ["Absorcion de poder","Acelerar","Ahogar la mente","Ajar un miembro","Aliento de las profundidades","Aliento de Pazuzu","Anudar carne","Atormentar","Atormentar","Canción de Hastur","Canto fúnebre de Nyhargo","Conceder atosbo de verdad","Cuchilla espectral","Danza de fuego","Declamación de la bilis","Desgarro temporal","Destello de Ra","Desvanecimiento","Desviar el daño","Dominar","Explosión mental","Garra de Cthulhu","Garra de Nyogtha","Golpe cegador","Gusanos","Hechizo mortal","Incinerar","Inducir el pánico","Ira de Pazuzu","Ira del tiempo","Liquidez","Maldición de Azathoth","Maldición de la piedra","Manos de colubra","Manto de fuego","Muerte liquida","Nube mental","Numantina","Ojos de un extraño","Petrificar las extremidades inferiores","Polvo dañino de Hermes trimegisto","Polvo de Ibn-Ghazi","Polvo de Suleimán","Puño de Yog-Sothoth","Roce de la decadencia","El signo rojo","Sugestión mental","Tormento inflamatorio","Trance","Vacío de sombras","Yugo de la lengua sangrienta"]
...
var Grimorio_crear_monstruos = ["Abosrber la sangre de la vida","Acelerar una larva de la niebla","Animar criatura de carne","Animar momia","Atadura gris","Beso del cementerio","Convertirse en un cazador espectral","Crar gólem","Crear hijo de la esfinge","Crear muerto viviente","Crear zombi","Despertar/Expulsar al dios interior","Efigie del odio","Fabricar elixir de la vida eterna","Maldicion de los seres rata","Obligar a la carne","Ojos de zombi","Piel que camina","Reanimación","Regreso del ser amado","Resurrección","Sombra de Nyarlathotep"]

var Grimorio_destierro_control = ["Ahurentar a un shan","Anzuelo para seres humanos","Atar a un ángel descarnado de la noche","Atar a un Byakhee","Atar a un Cambiaforma","Atar a un Hijo de la esfinge","Atar a un Horrendo cazador","Atar a un Profundo","Atar a un Retorño oscuro de Shub-Niggurath","Atar a un Servidor de los dioses exteriores","Atar a un Shoggoth","Atar a un Vagabundo Dimensional","Atar a un Vampiro de fuego","Atar a un Vampiro Estelar","Atrapar un alma","Canto fúnebre de Nyhargo","Cruz ansada de Prinn","Desenmascarar a un demonio","Destello de Ra","Desterrar a Apep","Desterrar a Byatis","Destierro de Yde Etad","Encarcelar mente","Encerrar a Eihort","Engañar a un soñador","Expulsar a un dios","Expulsar a un espíritu","Exuplsar a un shan","Expulsar al demonio","Extensión oscilante","Gracia elísea","Identificar a un espíritu","Inmovilizar a una victima","Llama purificadora de Vorvadoss","Maldición de la oscuridad","Mortificación","Pérdida de favor","Pesquisa de los no muertos","Polvo de Ibn-Ghazi","Polvo de Suleiman","Retornar servidor","Sellar pozo","Signo Voorish","Subyugar a las plantas","Subyugar a un shoggoth"]

var Grimorio_encantamiento = ["Armonizar cristal","Bendecir hoja","Collar de persuasión","Crear amuleto","Crear cayado mágico","Crear flauta maldita","Crear signo de Barzai","Crear tablilla maldita","Encantamiento de la mala suerte","Encantar amuleto de los primigenios","Encantar anillo","Encantar antorcha","Encantar atributos de poder","Encantar azagaya","Encantar bastón","Encantar brasero","Encantar campanas del horror","Encantar carne","Encantar cuadro","Encantar cuchillo","Encantar daga de Nyarlathotep","Encantar efigie animal","Encantar flauta","Encantar grabación","Encantar gris-gris","Encantar libro","Encantar muñeca","Encantar palo","Encantar palo","Encantar proyectil","Encantar silbato","Encantar suero","Encantar tablilla de piedra","Encantar vela","Imposición del Signo de Koth","Inutilizar objeto","Petrificar","Polvo encantado de Anubis","Vigilia ensoñadora"]

var Grimorio_influencia = ["Activación","Anzuelo para seres humanos","atar a un enemigo","Bacanal","Cimoticismo","Collar de persuasión","Conceder atisbo de verdad","Contactar con un humano","Crear signo de Barzai","Decadencia insidiosa","Dominar","Exalación","Exaltación del Ser sin Piel","Fabricar brebaje de Phan","Festín final, El","Hibernar","Inducir el pánico","Jaula dorada del deseo","Nube mental","Nublar la memoria","Obligar a la carne","Ojos de un extraño","Palabras poderosas","Pesadilla","Pesadillas","Reunir y canalizar el miedo","Signo de amarillo","Sugestión mental","Trance","Vocalizar el pensamiento","Voz de Ra"]

var Grimorio_otros = ["Absorción de poder","Alma errante","Atraer a un barco de peces","Beber del espíritu","Bendición de Bast","Buscar lo perdido","Cántico de poder","Cántico de Thoth","Colmillo de Yig","Consumir recuerdos","Danza mental","Descubrir encantamiento","Despertar la luz interior","Encontrar a un hombre serpiente","Encontrar a un soñador","Encontrar Portal","Localizar resonancia vital","Exaltación","Fabricar paut","Fórmula Dho","Gran rito del sacrificio","Hilo de Ariadna","Intuir la presencia del otro","Luz de luna","Luz de Seker","Mal de ojo","Mortificación","Percibir texto","Percibir vida","Perfección","Perspicacia de las almas gemelas","Poder de Nyambe","Preparar cadáver","Promesa innombrable","Reencarnación","Reunir y canalizar el miedo","Ritual de purificacion","Ritual del momoy","Serenidad terrenal","Singo de Voorish","Sofocar la sospecha","Transición espectral","Ver portal"]

var Grimorio_prolongar_vida = ["Absorber la sangre de la vida","Absorber la vida","Alimento de la vida","Crear Protección personal","Dividir el ka","Inmortalidad","Muda sagrada de la serpiente","Muerte de Koschéi, La","Pacto de Quachil Uttaus","Posesión","Prolongar vida","Resurrección","Transferencia de mente","Transferir alma","Transferir órgano","Transferir parte corporal"]

var Grimorio_proteccion = ["Calidez mental","Campana de Tezchaptl","Cántico de proteccion","Círculo de náusea","Circulo de proteccion","Crear barrera de Naach-Tith","Crear polvo contra zombis","Crear protección personal","Desviar el daño","Devorar filo","Dicha","Dividir el ka","Extensión oscilante","Extracción del alma","Formula de Einstein","Impetu del corazón","Imposición del Pentágono pnakótico","Imposición del Signo de Koth","Ojo de luz de oscuridad","Pegar carne","Protección","Protección contra el Mal de ojo","Protección de Anubis","Ritaul Saaamaaa","Rueda de niebla de Eibon","Sello de Isis","Sello de Nephren-Ka","Serenidad terrenal","Signo protector","Símbolo arcano","Trazar círculo","Vaciar la mente"]

var Grimorio_temporales = ["Adivinación","Conjurar cristal de Mortlan","Crear ventana de obsevación","Desgarro temporal","Fabricar droga de Liao","Fabricar parakete","Mirar al futuro","Mostrar el fin del camino","Portal temporal","Roce de la decadencia","Trampa temporal","Visión premonitoria"]

var Grimorio_tierra_del_sueño = ["Alzar a los fantasmas de Ib","Anatema","Anillos concéntricos del gusano","Barrera oblonga","Caja negra","Canción de Glissande","Cascada de Florin","Convocar a la plaga","Cortnas de encaje de Hish","Creación de venerabilidad","Dardos esmeralda de Ptath","Deflexión","Destripador","Disolver esqueleto","Encontrar a un soñador","Escudo flamígero","Esfera lavada de Ptath","Espiral de Suth","estabilidad","Explosión cardíaca","Explosión conmocionante","Expulsión onírica","Fabricar hidromiel espacial","Fauces del pandemónium","Fuerza irresistible","Gloria del serafín","Hechizo perdido de Ib, El","Hinchar","Horno de Bolonath","Invisibilidad","Involución","Ladrón de almas","Lasitud de Phein","Levantar a los muertos","Llama macilenta","La locura furiosa","Maldición de Cerrit","Mandrágora","Mente de hierro","Minimizar","Mundo de cristal","Niebla plateada, La","Ola de calor de Katarien","Pantalla equilátera","Paralización de Eanora","Pared opaca","Potencia de Throth","Rayo de Malenkamon","Red blanca de Soren","Ropas vivientes","Serpiente de Mnomquah","Sirviente","Torbellino","Traer la peste","Tremendo picor","Viento viridiano","Vórtice de viajes lejanos","X viviente"]

var Grimorio_tradicional = ["Agua del buen ladrón","Arruinar/bendecir cultivo","Atar a un animal","Atraer karma","Augurio","Bendición","Buscar lo perdido","Cantar al alma","Canto de sirena","Convocar a un fantasma","Crear amuleto de buena suerte","Crear bulla","Crear tormenta","Curación","Despertar a la bestia","Encantar ju-ju","Encatar paviut","Envenenamiento sanguíneo","Fabricar filtro de amor","Festín de la lechuza","Formar de murciélago","Furia","Hechizar a un animal","Lanzamiento impecable","Lisiar/Curar a un animal","Maldición","MEditación restauradora","Patas de oso","Piel de oso","Polvo de coyote","Prosperidad","Radiestesia","Revés de la fortuna","Sello amarillo de salto espiritual","Serenidad terrenal","Subyugar a un animal","Vaciar la mente","Ven a verme","Vientos de la desolación"]

var Grimorio_traer_monstruos_o_dioses1 = ["Abismo al infierno","Ángulos inversos de Tagh-Clatur","Canalización divina","Conjuración del turua","Construir Carcosa","Contactar con Abhoth","Contactar con Aku-shin Kage","Contactar con Azathoth","Contactar Bokrug","Contactar Byatis","Contactar Chaugnar Faugn","Contactar Cthulhu","Contactar Eihort","Contactar con la Lama Esmeralda","Contactar con Ghroth","Contactar Gla´aki","Contactar con Iod","Contactar Koth","Contactar con los Maestros","Contactar con los espíritus de los muertos","Contactar con Nodens","Contactar con Nyarlathotep","Contactar Nyarlatophis","Contactar con Othuyeg","Contactar con Pazuzu","Contactar con Shub-Niggurath","Contactar con Tsathoggua","Contactar con un antiguo","Contactar con un chtonian","Contactar con un gnoph-keh","Contactar con un gul","Contactar con un habitante de la arena","Contactar con un humano","Contactar con un lloigor","Contactar mi-go","Contactar con un perro de Tíndalos","Contactar con un pólipo volante","Contactar con un profundo","Contactar con un ser rata","Contactar con un servidor de los dioses exteriores","Contactar con un yithiano","Contactar con una bestia lunar","Contactar con una manada espulcral","Contactar con una semilla estelar de Cthulhu","Contactar con una semilla informe","Contactar con Y´golonac","Contactar con Yig","Contactar con Yog-Sothoth","Contactar con Zhar y Lloigor","Contactar con Zhar y Lloigor","Contactar Zoth-Ommog","Convocacion espiritual","Convocar a un ángel descarnado de la noche","Convocar a un baka","Convocar a un byakhee","Convocar a un desh mayor","Convocar a un dhole","Convocar a un hermano de Chaugnar Faugn ","Convocar ","Convocar ","Convocar a un horrendo cazador","Convocar a un profundo","Convocar a un reto{p oscuro de Shub-Niggurat","Convocar a un servidor de los dioses exteriores","Convocar a un Shoggoth","Convocar a un vagabundo dimensional","Convocar a un vampiro de fuego","Convocar a un vampiro estelar","Despertar a Abhoth","Despertar a Chuma","Ensalmo de la sexta sathlatta","Hablar con la Oscuridad que Espera","Hechizos de convocación","Invocar al Gusano","Liberar a Hastur","Llamada del cristal","Llamar a Ahtu","Llamar a Aku-shin Kage","Llamar a Arwassa","Llamar a Azathoth","Llamar a Bugg-Shash","Llamar Cthugha","Llamar Cyaegha","Llamar a Daoloth","Llamar a El Negro","Llamar a Ghatanothoa","Llamar a Gla´aki","Llamar a Gol-Goroth","Llamar a Hastur","Llamar a Iod","Llamar a Ithaqua","Llamar a la bestia","Llamar a La llorona"]

var Grimorio_traer_monstruos_o_dioses2 = ["Lamar a la Negrura","Llamar a los zombis","Llamar a Mappo no Ryuujin","Llamar a M´nagalah","Llamar a Nyogtha","Llamar a Ossadogowah","Llamar a Rlim Shaikorth","Llamar a Saaitii","Llamar a Shub-Niggurath","Llamar a un avatar del Ser sin Piel","Llamar a Yibb-Tstll","Llamar a Yig","Llamar a Yog-Sothoth","Llamar a Zu-Che-Quon","Llamar al Guardián de la Lente Lunar","Llamar al Hombre Astado","Llamar al Ser sin Piel","Luz de la verdad sagrada","Molestar a las crias","Promesa innombrable","Suplicar a Caronte"]

var Grimorio_transformacion = ["Acelerar","Acelerar la voz de las profundidades","Alcanzar","Aliento del kappa","Apariencia humana","Arbusto humano","Cántico de residencia","Controlar piel","Corrupción de lo sagrado","Cortar lazos cordiales","Destrasferencia","Don de Innanna","Fabricar droga de Liao","Imitar apariencia","Incorpóreo de la red","Infuencia benévola","Intercambio de mente","Máscara de muerte","Mirada interior","Ojos de zombi","Poseer cadáver","Posesión","Sentidos demoníacos","Sofocar sopecha","Trasferencia de mente","Transferir alma","Transferir órgano","Transferir parte corporal","Transformación","Transformación corporal de Gorgoroth","Volver incorpóreo","Yugo de la lengua sangriente"]

var Grimorio_viajes_y_trasportacion = ["Alma errante","Ascender la escalera de la inmortalidad","Ayudar a un soñador","Cajas-portal","Crear ventana","Desgarrar velo","Desvanecimiento","Fabricar droga de Liao","Fabricar hidromiel espacial","Fabricar parakete","Levitar","Portal","Portal al limbo","Portal de los sueños","Portal temporal","Preparar droga onírica","Puerta onirológica","Ritual del momoy","Trasladar portal","Ver portal","Viaje al otro lado","Volar"]
