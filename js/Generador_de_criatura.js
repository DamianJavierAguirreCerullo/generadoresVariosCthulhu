...
var Dagon_e_hidra = {
        ...
        Ataques_por_asalto : "2",
        Ataques_de_combate : "Estos monstruos descomunales pueden golpear a los investigadores de varias formas distintas: pateando, desgarrando, pisoteando, aporreando, etc. <br><em>Combatir</em> 80% (40/18), daño 1D6 + Bonificación al daño." ,
...
var Dhole = {
        ...
        Habilidades : "<em>Combatir</em> 30%, daño muerte . <br><em>Escupir baba</em> 50 %, daño especial. <br><em>Engullir</em> 80%, daño engullido. <br><em>Esquivar</em> 6%." ,
...
var Ghast = {
        ...
        Habilidades : "<em>Combatir</em> 45% (22/9), daño 1D6 + Bonificación al daño.<br><em>Esquivar</em> 35% (17/7). <br> Sigilo 70%." ,
...
var Gnoph_keh = {
        ...
        Habilidades : "<em>Combatir</em> 45% (22/9), daño 1D6 + Bonificación al daño. <br><em>Cornada</em> 65% (32/13), daño 1D10 + Bonificación al daño. <br><em>Esquivar</em> 35% (17/7) ." ,
...
var Gul = {
        ...
        Habilidades : "<em>Combatir</em> 40% (20/8), daño 1 D6 + Bonificación al daño. Morder y retener (mnbr) daño 1 04 por asalto . <br><em>Esquivar</em> 40% (20/8)." ,
 ...
 var Habitante_de_las_arenas = {
        ...
        Habilidades : "<em>Combatir</em> 30% (15/6), daño 1D6 + Bonificación al daño.<br><em>Esquivar</em> 30% (15/6).<br><em>Descubrir</em> 50%, <br><em>Escuchar</em> 60%, <br><em>Sigilo</em> 55%." ,
 ...
 var Hombre_serpiente = {
        ...
        Habilidades : "<em>Combatir</em> 50% (25/10), daño 1D3 + Bonificación al daño. <br><em>Mordisco</em> 35% (17/7), daño 1D8 + veneno (como se indicaba anteriormente). <br><em>Esquivar</em> 32% (16/6)." ,
 ...
 var Lloigor = {
        ...
        Habilidades : "<em>Combatir</em> 30% (15/6), daño 1D6 + Bonificación al daño. <br><em>Esquivar</em> 26% (13/5) . <br><em>Armadura:</em> 8 puntos de piel de reptil. En su estado inmaterial son inmunes a todas las armas físicas, sean mágicas o no." ,
        Cordura : "0/1D8 en su forma de reptil; su forma invisible no provoca ninguna pérdida de Cordura; el contacto mental produce una pérdida de 1/104 Puntos de Cordura."
 }
 ...
 var Migo = {
        ...
        Ataques_por_asalto : "2" ,
        Ataques_de_combate : "Los hongos de Yuggoth pueden atacar  en combate cuerpo a cuerpo con sus dos garras parecidas  a pinzas.  <br><strong>Capturar (mnbr):</strong> También pueden intentar apresar a su víctima  (de una corpulencia igual o menor a la suya) para luego  alzar el vuelo y dejarla caer desde gran altura, o llevarla a la  altitud suficiente para que sus pulmones co lapsen.  <br><em>Combatir</em> 45% (22/9), 106 + Bonificación al daño.  <br><em>Capturar (mnbr)</em> puede capturar seres que tengan una Corpulencia  1gual o menor a la suya (pinzas, apresar, volar)." ,
        Habilidades : "Combatir</em> 45% (22/9), 106 + Bonificación al daño. <br><em>Capturar (mnbr)</em> puede capturar seres que tengan una Corpulencia 1gual o menor a la suya (pinzas, apresar, volar). <br><em>Esquivar</em> 35% (17 /7)." ,
 ...
 var Perros_de_tindalos = {
        ...
        Habilidades : "<em>Combatir</em> 90% (45/18), daño 1D6 + Bonificación al daño + icor (2D6 daño por asalto, de forma continuada hasta retirarlo).<br><em>Lengua</em> 90% (45/18), daño 3D6 POD drenado por asalto. <br><em>Esquivar</em> 26 % (13/5)." ,
        Cordura : "Ver a un pe rro de Tíndalos produce una pérdida de 1D3/1D20 Puntos de Cordura."
 }
 ...
 var Polipo_volante = {
        ...
        Habilidades : "<em>Combatir</em> 85 % (42/17), daño 1D10.<br> Ráfaga de viento 70% (35/14), Bonificación al daño (se reduce en 1 D6 por cada 20 m de distancia).<br> <br><em>Esquivar</em> 30% (15/6)." ,
